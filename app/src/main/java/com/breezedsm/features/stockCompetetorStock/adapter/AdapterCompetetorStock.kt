package com.breezedsm.features.stockCompetetorStock.adapter
...
import com.breezedsm.app.domain.CurrentStockEntryModelEntity
import com.breezedsm.features.stockAddCurrentStock.`interface`.ShowStockOnClick
